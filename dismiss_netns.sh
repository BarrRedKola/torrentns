...
function show_help 
 { 
 	c_print "Green" "This script dismisses network namespace <NAMESPACE> and stops transmission, and socat, but lets any running openvpn instance to be still present"
